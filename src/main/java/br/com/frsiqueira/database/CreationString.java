...
public class CreationString {
    ...
    static final String createPaymentTable = "CREATE TABLE IF NOT EXISTS payment(id INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT, parcel integer, date DATE NOT NULL, type VARCHAR(20), amount DECIMAL(13, 2) NOT NULL, paid BOOLEAN) ENGINE=INNODB;";
    ...
    static final String insertApartmentTable = "REPLACE INTO apartment(name, address, release_date) VALUES('LIVING CLÁSSICO', 'R. Dr. Ribeiro de Almeida, 88', '2022-03-01');";
    static final String insertPaymentTable = "REPLACE INTO payment(parcel, date, type, amount, paid) VALUES(1, '2018-11-15', 'parcel', '3011.41', true);";

    static final String deleteApartmentTable = "DELETE FROM apartment";
    static final String deletePaymentTable = "DELETE FROM payment";
}